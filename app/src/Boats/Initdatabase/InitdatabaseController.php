<?php
namespace TBJ\Navigare\Boats\Initdatabase;
...
class InitdatabaseController implements \Anax\DI\IInjectionAware
{
   ...
   */
   ...
   private $stmt = null;               // The latest statement used to execute a query
    ...
    public function initAction($params){
        ...
        $this->questionTableAction();
        $this->insertQuestionsAction();
        $this->answerTableAction();
        $this->insertAnswersAction();
        $this->commentTableAction();
        $this->insertCommentsAction();
        $this->tagsTableAction();
        $this->insertTagsAction();
        $this->tags2QuestionsTableAction();
        $this->insertTags2QuestionsAction();
        $this->usersTableAction();
        $this->insertUsersAction();
        $this->voteTableAction();
        $this->emptyrowAction();
        $this->activeUserViewAction();
    }
    
    private function questionTableAction() {
        $sql = "DROP TABLE IF EXISTS `boats_questions`;
        ...
        if($res) {
            $message = "Frågetabellen skapades.<br>";
        } else {
            $message = "Frågetabellen kunde inte skapas.<br>"; 
        }
        return $message;
    }

    private function insertQuestionsAction() {
        $sql = "INSERT INTO `boats_questions` (`id`, `title`, `question`, `userid`, `rank`, `created`, `updated`, `deleted`) VALUES
        ...
        ";
         ...
         $res = $this->stmt->execute();
        if($res) {
            $message = "Frågor har infogats.<br>";
        } else {
            $message = "Frågorna kunde inte infogas.<br>"; 
        }
        return $message;
    }
    
    private function answerTableAction() {
        $sql = "DROP TABLE IF EXISTS `boats_answers`;
        ...
        if($res) {
            $message = "Svarstabellen skapades.<br>";
        } else {
            $message = "Svarstabellen kunde inte skapas.<br>"; 
        }
        return $message;
    }  
    
    private function insertAnswersAction() {
        $sql = "INSERT INTO `boats_answers` (`id`, `answer`, `userid`, `questionid`, `rank`, `vote`, `accepted`, `created`, `updated`, `deleted`) VALUES
        ...
        ";
         ...
         $res = $this->stmt->execute();
        if($res) {
            $message = "Svar har infogats.<br>";
        } else {
            $message = "Svaren kunde inte infogas.<br>"; 
        }
        return $message;
    } 
    
    private function commentTableAction() {
        $sql = "DROP TABLE IF EXISTS `boats_comments`;
        ...
        if($res) {
            $message = "Kommentarstabellen skapades.<br>";
        } else {
            $message = "Kommentarstabellen kunde inte skapas.<br>"; 
        }
        return $message;
    }  
    
    private function insertCommentsAction() {
        $sql = "INSERT INTO `boats_comments` (`id`, `comment`, `userid`, `questionid`, `answerid`, `rank`, `created`, `updated`, `deleted`) VALUES
        ...
        ";
         ...
         $res = $this->stmt->execute();
        if($res) {
            $message = "Kommentarer har infogats.<br>";
        } else {
            $message = "Kommentarer kunde inte infogas.<br>"; 
        }
        return $message;
    } 
    
    private function tagsTableAction() {
        $sql = "DROP TABLE IF EXISTS `boats_tags`;
        ...
        if($res) {
            $message = "Ämnestabellen skapades.<br>";
        } else {
            $message = "Ämnestabellen kunde inte skapas.<br>"; 
        }
        return $message;
    }  
    
    private function insertTagsAction() {
        $sql = "INSERT INTO `boats_tags` (`id`, `name`, `deleted`) VALUES
        (3, 'Elsystem', NULL),
        (5, 'Säkerhet', NULL),
        (6, 'Inredning', NULL),
        (7, 'Motor', NULL),
        ...
        ";
         ...
         $res = $this->stmt->execute();
        if($res) {
            $message = "Ämnen har infogats.<br>";
        } else {
            $message = "Ämnena kunde inte infogas.<br>"; 
        }
        return $message;
    }   
    
    private function tags2QuestionsTableAction() {
        $sql = "DROP TABLE IF EXISTS `boats_tags2question`;
        ...
        if($res) {
            $message = "Kopplingstabellen skapades.<br>";
        } else {
            $message = "Kopplingstabellen kunde inte skapas.<br>"; 
        }
        return $message;
    }  
    
    private function insertTags2QuestionsAction() {
        $sql = "INSERT INTO `boats_tags2question` (`id`, `tag_id`, `question_id`) VALUES
        (149, 3, 53),
        (150, 14, 53),
        (151, 24, 53),
        (169, 7, 64),
        ...
        ";
         ...
         $res = $this->stmt->execute();
        if($res) {
            $message = "Kopplingstabellvärden har infogats.<br>";
        } else {
            $message = "Kopplingstabellvärden kunde inte infogas.<br>"; 
        }
        return $message;
    }      
    
    private function usersTableAction() {
        $sql = "DROP TABLE IF EXISTS `boats_user`;
        ...
        if($res) {
            $message = "Användartabellen skapades.<br>";
        } else {
            $message = "Användartabellen kunde inte skapas.<br>"; 
        }
        return $message;
    }  
    
    private function insertUsersAction() {
        $sql = "INSERT INTO `boats_user` (`id`, `acronym`, `email`, `name`, `password`, `created`, `updated`, `deleted`, `active`) VALUES
        ...
        ";
         ...
         $res = $this->stmt->execute();
        if($res) {
            $message = "Användare har infogats.<br>";
        } else {
            $message = "Användarna kunde inte infogas.<br>"; 
        }
        return $message;
    }    
    
    private function voteTableAction() {
        $sql = "DROP TABLE IF EXISTS `boats_votes`;
